...
WebUI.click(findTestObject('Page_OrangeHRM/div_Admin'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Enabled'))

WebUI.setText(findTestObject('Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/input'), 'John Smith')
