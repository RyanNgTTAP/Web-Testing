...
WebUI.click(findTestObject('Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/i_Actions_oxd-icon bi-check oxd-checkbox-input-icon'))
...
WebUI.click(findTestObject('AddJobTitle/Page_OrangeHRM/button_Yes, Delete'))
