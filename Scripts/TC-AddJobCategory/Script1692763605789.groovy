...
WebUI.setText(findTestObject('Object Repository/AddJobCategory/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), 'BA SCM')
...
WebUI.setText(findTestObject('Object Repository/AddJobCategory/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus oxd-i_ad7396'), 
    'BA SCM')
