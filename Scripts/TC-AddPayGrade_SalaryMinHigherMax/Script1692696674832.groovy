...
WebUI.click(findTestObject('AddPayGrade/Page_OrangeHRM/button_Add'))

WebUI.click(findTestObject('Object Repository/AddPayGrade/Page_OrangeHRM/div_Currency-- Select -- (1)'))

WebUI.click(findTestObject('Page_OrangeHRM/i_-- Select --_oxd-icon bi-caret-up-fill oxd-select-text--JobTitle'))

WebUI.click(findTestObject('AddPayGrade/Page_OrangeHRM/div_AED - Utd. Arab Emir. Dirham'))

WebUI.setText(findTestObject('AddPayGrade/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/input_Minimum Salary_oxd-input oxd-input--focus'), 
    '1000')

WebUI.setText(findTestObject('AddPayGrade/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/input_Maximum Salary_oxd-input oxd-input--active'), 
    '500')

WebUI.click(findTestObject('Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/button_Save'))

WebUI.verifyTextPresent('Should be higher than Minimum Salary', false)
