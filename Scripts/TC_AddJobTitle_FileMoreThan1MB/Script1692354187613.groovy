...
WebUI.click(findTestObject('Object Repository/AddJobTitle/Page_OrangeHRM/div_Browse'))

WebUI.click(findTestObject('Object Repository/AddJobTitle/Page_OrangeHRM/i_Copy of Order Comparison - 17 Aug 2023.xl_d735a8'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/AddJobTitle/Page_OrangeHRM/div_Copy of Order Comparison - 17 Aug 2023.xlsx'), 
    FailureHandling.STOP_ON_FAILURE)
